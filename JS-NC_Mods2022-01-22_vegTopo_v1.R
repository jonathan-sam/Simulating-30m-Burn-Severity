...
# set up of prediction model from Jonathan Sam for North Coast (2021-09-22)
...
load(paste0(workspaceRootDir,'Baldwin/Models/JonathanSam/JS-Mods_2022-01-22/Downscaling_NCMods0122.vegTopo.v1.rda'))
LMH.mod.i0 <- LMHmod_NC
MH.mod.i0 <- MHmod_NC
H.mod.i0 <- Hmod_NC
rm(LMHmod_NC, MHmod_NC, Hmod_NC)

LMH.mod.i1 <- LMHmod_NC_wW_all
MH.mod.i1 <- MHmod_NC_wW_all
H.mod.i1 <- Hmod_NC_wW_all
rm(MHmod_NC_wW_all, Hmod_NC_wW_all, LMHmod_NC_wW_all)
